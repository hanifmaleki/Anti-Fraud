...
public class TransactionDataProvider {
    ...
    public class TestTransaction {
        ...
        public Transaction build() {
            ...
            String cardSerial = cardStolen ? data.ipCard.stolenCard1 : data.ipCard.okCard1;
        ...
        private Integer getManualTransaction(TransactionType type) {
            int bound = type.getMaxManual() - type.getMaxAllowed();
            return new Random().nextInt(bound) + type.getMaxManual();
        }
    ...
    public Transaction getAllowedTestTrxRequest() {
        return getAllowedTransaction(data.trxType.testTransactionType);
    }

    public Transaction getAllowedTransaction(TransactionType randomValidTransactionType) {
        return builder()
