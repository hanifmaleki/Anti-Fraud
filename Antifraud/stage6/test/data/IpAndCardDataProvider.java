...
public class IpAndCardDataProvider {
    ...
    public static final String STOLEN_ADDRESS  = BASE_ADDRESS + "/stolencard";
    public static final String IP_ADDRESS = BASE_ADDRESS + "/suspicious-ip";


    // Cards
    public final String stolenCard1;
    public final String stolenCard2;
    public final String okCard1;
    public final String okCard2;
    ...
    public IpAndCardDataProvider() {
        ...
        okCard1 = "5105-1051-0510-5100";
        okCard2 = "5105-1051-0510-5200";
