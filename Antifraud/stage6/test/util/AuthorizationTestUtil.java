...
public class AuthorizationTestUtil /*extends BaseTestUtil*/ {
    ...
    private final CardTestUtil cardUtil;
    private final IPTestUtil ipTestUtil;
    ...
    private final AntifraudBaseTest testClass;

    public AuthorizationTestUtil(AntifraudBaseTest testClass, CardTestUtil cardUtil, IPTestUtil ipTestUtil, TransactionTestUtil transactionUtil, UserTestUtil userUtil, TransactionTypeTestUtil typeUtil, TestDataProvider data) {
        this.testClass = testClass;
        this.cardUtil = cardUtil;
        this.ipTestUtil = ipTestUtil;
        ...
        privilegeMethodsMap.put(Privilege.IP_MANAGEMENT, ipTestUtil::isAuthorizedIpGet);
